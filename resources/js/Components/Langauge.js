    ...
    return (
        <div className="dropdown">
            ...
            >
                ...
                <span className="text text-capitalize text-sm mx-1">
                    {translate(language)}
                </span>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <ul className="dropdown-menu dropdown-menu-end border-0 shadow-sm">
                <li>
                    <a className="dropdown-item" href="/set/language?lang=en">
                        {translate("English")}
                    </a>
                </li>
                <li>
                    <a className="dropdown-item" href="/set/language?lang=de">
                        {translate("German")}
                    </a>
                </li>
            </ul>
