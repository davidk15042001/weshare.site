<!DOCTYPE html>
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="notranslate" translate="no">
    <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta name="translations" content="<?php echo e(config('translations.content')); ?>">
        

        <title inertia><?php echo e(config('app.name', 'WeShare.Site')); ?></title>
        ...
        <?php if(env('APP_ENV') == 'local'): ?>
            <link rel="stylesheet" href="<?php echo e(mix('/css/app.dev.css')); ?>">
            <?php echo app('Tightenco\Ziggy\BladeRouteGenerator')->generate(); ?>
            <script src="<?php echo e(mix('/js/app.dev.js')); ?>" defer></script>
        <?php else: ?>
        ...
        <link rel="apple-touch-icon-precomposed" sizes="57x57" href="<?php echo e(URL::asset('/assets/images/favicon-57x57.png')); ?>" />
    </head>
...
<?php /**PATH C:\Laravel projects\weshare\resources\views/app.blade.php ENDPATH**/ ?>